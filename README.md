...
# OR
mamba install biopython blas=2.5 blast=2.6.0 bmtagger bowtie2 bwa concoct=1.0 checkm-genome fastqc kraken=1.1 kraken=2.0 krona=2.7 matplotlib maxbin2 megahit metabat2 pandas pplacer prokka quast r-ggplot2 r-recommended salmon samtools=1.9 seaborn spades trim-galore
